...
{
    /// <summary>
    /// Event of a worklog added to a project
    /// </summary>
    public class WorklogAddedEvent : INotification
    {
        /// <summary>
        /// Gets the code of the project the worklog was added to
        /// </summary>
        ...
        /// <summary>
        /// Default constructor for worklog added event
        /// </summary>
        ...
        public WorklogAddedEvent(string projectCode, DateTime workEnded, DateTime workstarted, string description, double kilometersCovered,
